...
For the first run, start small: one city, one cuisine such as `pizza`, `maxResults` between 5 and 10, and the recommended India residential proxy enabled.
...
- India residential proxies are recommended for reliable regional access and are billed as platform usage.
